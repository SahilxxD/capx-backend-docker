...
const PorfolioPage = () => {
    ...
    const fetchPortfoliodData = async () => {
        ...
        try {
            const response = await axios.get(`https://${apiUrl}/data/portfolio`, {
            });
    ...
    const addStockApi = async (stock, quantity, action) => {
        ...
        try {
            const response = await axios.post(`https://${apiUrl}/portfolio/add`, {
                body: {
                    symbol: stock.symbol,
                    name: stock.name,
    ...
    const modifyStock = async (stock, action, quantity) => {
        ...
        const apiUrl = process.env.REACT_APP_API_URL;
        try {
            const response = await axios.post(`https://${apiUrl}/portfolio/update`, {
                body: {
                    symbol: stock.symbol,
